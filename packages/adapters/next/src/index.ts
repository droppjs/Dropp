 ...
 * ```typescript
 * import { handleUpload } from "@droppjs/adapter-next";
 ...
 * ```typescript
 * import { handleGetMedia } from "@droppjs/adapter-next";
 * import { dropp } from "@/lib/dropp";
 *
 ...
 * Usage in app/api/media/[id]/route.ts:
 * ```typescript
 * import { handleDeleteMedia } from "@droppjs/adapter-next";
 * import { dropp } from "@/lib/dropp";
 *
 ...
 * ```typescript
 * import { handleGetModelMedia } from "@droppjs/adapter-next";
 * import { dropp } from "@/lib/dropp";
 *
 * export async function GET(
 *   request: NextRequest,
